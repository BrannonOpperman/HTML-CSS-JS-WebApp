...
$(".third").click(onThirdCircle);
$(".fourth").click(onFourthCircle);
$(".fifth").click(onFifthCircle);
$(".sixth").click(onSixthCircle);
$(".seventh").click(onSeventhCircle);
$(".eighth").click(onEighthCircle);
$(".nineth").click(onNinethCircle);
...
$(".seventeenth").click(onSeventeenthCircle);
$(".eighteenth").click(onEighteenthCircle);

function onFirstCircle(){
    $(".second").removeClass("clicked");
    $(".third").removeClass("clicked");
    $(".fourth").removeClass("clicked");
    $(".fifth").removeClass("clicked");
    $(".sixth").removeClass("clicked");
    $(".seventh").removeClass("clicked");
    $(".eighth").removeClass("clicked");
    $(".nineth").removeClass("clicked");
    $(".tenth").removeClass("clicked");
    $(".eleventh").removeClass("clicked");
    $(".twelfth").removeClass("clicked");
    $(".thirteenth").removeClass("clicked");
    $(".fourteenth").removeClass("clicked");
    $(".fifteenth").removeClass("clicked");
